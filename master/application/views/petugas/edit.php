			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<?php echo form_open('Petugas/update/'.$this->uri->segment(3)); ?>
							...
							<div class="form-group">
								...
								<input value="<?php echo $petugas[0]->nama_petugas ?>" id="nama_petugas" id="nama_petugas" name="nama_petugas" type="text" class="form-control">
							</div>
